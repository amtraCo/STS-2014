...
function setup()    
    ...
    function drawbibliography()
        ...
        text("http://www.sciencekids.co.nz/sciencefacts/food/carrots.html", 512, 425)
        text("http://www.sciencekids.co.nz/sciencefacts/food/potatoes.html", 512, 380)
        text("http://www.wheatworld.org/wheat-info/fast-facts/", 512, 330)
        text("http://en.wikipedia.org/wiki/Genetically_modified_organism", 512, 280)
